#!/bin/bash
# UTMIST AI^2 Training Setup for Vast.ai
# ==========================================
...
echo "  cd .."
echo "  python3 train.py --cfgFile config.yaml"
echo ""
echo "To monitor training with TensorBoard:"
echo ""
echo "  tensorboard --logdir ./results/ppo_utmist/tb --port 6006"
echo ""
echo "To run training in background (recommended):"
echo ""
echo "  nohup python3 train.py --cfgFile config.yaml > training.log 2>&1 &"
